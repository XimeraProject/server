...
var adjectives = ["quick", "gray", "red", "orange", "green", "blue", "purple", "brown", "magenta", "maroon", "navy", "silver", "gold", "lime", "teal", "indigo", "violet", "bright", "tall", "short", "dark", "cloudy", "summer", "winter", "spring", "fall", "autumn", "windy", "noisy", "loud", "quiet", "heavy", "light", "strong", "powerful", "sour", "bitter", "beautiful", "good", "bad", "great", "important", "useful", "free", "fine", "sad", "proud", "lonely", "frowning","comfortable", "happy", "clever", "interesting", "famous", "exciting", "funny", "kind", "polite", "fair", "careful", "rainy", "humid", "arid", "frigid", "foggy", "windy", "stormy", "breezy", "windless", "calm", "still"];

var nouns = ['mountain','tree','lake','water','river','ocean','sea','gulf','bay','town','city','village','house','bird','fish','cat','dog','flower','butterfly','owl','book','hummingbird','eyes','building','home','raft','number','expression','equation','manifold','group','ring','set','prime','square','hexagon','cube','quadrilateral','rectangle','rhombus','parallelogram','trapezoid','tetrahedron','octahedron','circle','sphere','dodecahedron','icosahedron','disk','line','angle','chord','arc','approximation','function','formula','calculation','matrix','solution','theorem','fact','lemma','castle'];
	     
function shaToPoeticName(sha) {
    ...
    return sha.substr(0,6) + "&hellip;: &ldquo;" + capitalizeFirstLetter(phrase.toLowerCase()) + ".&rdquo;";
}

module.exports.shaToPoeticName = shaToPoeticName;

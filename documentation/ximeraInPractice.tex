...
include a headline, title, prerequisites, and outcomes.
...
The headline should be a one sentence description of the activity, and
must come before the title. Each prerequisite and outcome should be
without spaces, and every attempt should be made to use already

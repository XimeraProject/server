...
\immediate\write18{git rev-parse HEAD > \jobname.info}
...
\begin{tikzpicture}[x=1in,y=1in] 
  \begin{scope}
    ...
    \node[anchor=west,redback] at (.15,.1) {\tiny\textbf{XIMERA\quad FORM \quad 1368 \quad GIT \quad COMMIT \quad \input{\jobname.info} \quad PREVIOUS \quad EDITION \quad IS \quad OBSOLETE.}};
  \end{scope}
  \end{tikzpicture}
\end{document}
